...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(Context context, ArrayList<MyModel> arrList, String lat, String lng) {
        this.lat = lat;
        this.lng = lng;
    ...
    public MyAdapter(Context context, ArrayList<MyModel> arrList) {
        this.context = context;
        this.arrList = arrList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (TextUtils.isEmpty(model.getLat()))
            model.setLat(Util.check_null());
        if (TextUtils.isEmpty(model.getLng()))
            model.setLng(Util.check_null());
        ...
        holder.distance.setText(model.getDistance() + " miles away");

        holder.view.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View view) {
                Log.d("TAG", model.getUsertype());
                if (model.getUsertype().equals("Receipant"))
                {
                    new AlertDialog.Builder(view.getRootView().getContext()).setTitle("Error!")
                    .setMessage("Donors can not send Emails to Recipients.")
